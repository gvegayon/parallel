...
//Added to allow string literals (const char *) to be displayed without compiler warnings
#define SF_display_const(a)			SF_display((char *)(a))
#define SF_error_const(a)			SF_error((char *)(a))
#define SF_macro_save_const(m,t)	((_stata_)->macresave((char *)(m),(t)))
